    ...
    <div id="container">
        <div class="sidebar">
            <ul id="nav">
                ...
                <li>
                    <span>
                        <img src="http://www.webhostingreviewsbynerds.com/wp-content/plugins/rss-poster/cache/e17b1_fnal-570x456.png" width="32" height="32" /> </span><a href="#">Sale Details</a>
                </li>
            </ul>
        </div>
